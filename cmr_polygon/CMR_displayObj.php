...
<html>
    ...
    <body onload="initialize_map();">
        ...
        //$("#document").ready(function () {
            ...
            var map;
            var minX = 105.638565063477;
            var minY = 20.9646587371826;
            var maxX = 105.932662963867;
            var maxY = 21.081823348999;
            ...
            function initialize_map() {
                ...
                var layerCMR_adm1 = new ol.layer.Image({
                    source: new ol.source.ImageWMS({
                        ratio: 1,
                        url: 'http://localhost:8080/geoserver/cite/wms?service=WMS&version=1.1.0&request=GetMap&layers=cite%3Ahotel&bbox=105.638565063477%2C20.9646587371826%2C105.932662963867%2C21.081823348999&width=768&height=330&srs=EPSG%3A4326&styles=&format=application/openlayers',
                        params: {
                            'FORMAT': format,
                            'VERSION': '1.1.1',
                            STYLES: '',
