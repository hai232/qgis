<?php
    ...
    {
        // Kết nối CSDL
        $paPDO = new PDO('pgsql:host=localhost;dbname=Bai3;port=5432','postgres','123456');
        return $paPDO;
    }
    ...
    {
        $mySQLStr = "SELECT ST_AsGeoJson(geom) as geo from \"hotel\"";
        $result = query($paPDO, $mySQLStr);
    ...
    function example3($paPDO,$paSRID,$paPoint)
    {
        ...
        echo $paPoint;
        echo "<br>";
        //$mySQLStr = "SELECT ST_AsGeoJson(geom) as geo from \"hotel\" where ST_Within('SRID=4326;POINT(12 5)'::geometry,geom)";
        $mySQLStr = "SELECT ST_AsGeoJson(geom) as geo from \"hotel\" where ST_Within('SRID=".$paSRID.";".$paPoint."'::geometry,geom)";
        echo $mySQLStr;
        echo "<br><br>";
        $result = query($paPDO, $mySQLStr);
    ...
    function getInfoCMRToAjax($paPDO,$paSRID,$paPoint)
    {
        ...
        //$mySQLStr = "SELECT ST_AsGeoJson(geom) as geo from \"hotel\" where ST_Within('SRID=4326;POINT(12 5)'::geometry,geom)";
        //$mySQLStr = "SELECT ST_AsGeoJson(geom) as geo from \"hotel\" where ST_Within('SRID=".$paSRID.";".$paPoint."'::geometry,geom)";
        $mySQLStr = "SELECT gid, ST_Area(geom) as shape_leng, ST_Perimeter(geom) as shape_area from \"hotel\" where ST_Within('SRID=".$paSRID.";".$paPoint."'::geometry,geom)";
        //echo $mySQLStr;
        //echo "<br><br>";
        $result = query($paPDO, $mySQLStr);
